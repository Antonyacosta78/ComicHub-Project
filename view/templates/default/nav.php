...
<div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <a href="perfil.html"><div id="div-img-user"><img class="img-fluid" id="img-user" src="<?php echo $_SESSION['user']['Userimg'];?>" alt="Foto de <?php echo $_SESSION['user']['Username']; ?>" 
                ...
                <?php if(!isset($_SESSION['user'])):?>
                <li>
                    <div class="btn-menu" title="login"><a style="color: #999999;" role="button" data-toggle="modal" data-target="#loginModal"><i class="fa fa-sign-in"></i></a></div>
                </li>
                
                <li>
                    <div class="btn-menu" title="Registrar-se"><a href="<?php echo $this->base_url; ?>Register"><i class="fa fa-user-plus"></i></a></div>
                </li>
                <?php endif;?>
            </ul>
        </div>
